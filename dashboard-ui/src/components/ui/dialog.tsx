  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          'fixed left-1/2 top-1/2 z-50 w-[min(92vw,640px)] -translate-x-1/2 -translate-y-1/2 rounded-[1.5rem] border border-white/10 bg-card p-6 shadow-2xl shadow-black/40 outline-none',
          className,
        )}
        {...props}
      >
